...
def main():
    ...
    print("""
  ######################################
  # 6SFG Development Environment Setup #
  ######################################

  This script will create your 6SFG dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your 6SFG project folder:
    [Arma 3 installation directory]\\{} => 6SFG project folder
    P:\\{}                              => 6SFG project folder
