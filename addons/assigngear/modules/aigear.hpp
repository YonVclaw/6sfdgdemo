class GVAR(aiGearModule) : Module_F {
    ...
    category = "6sfg";
    icon = QPATHTOEF(common,ui\logo_6sfg_small_ca.paa);
    ...
    class ModuleDescription: ModuleDescription {
        description = "Bulk assigns gear to AI units.<br/>Used roles are defined in (configFile >> ""6SFG_AIGear""), which can be overwritten via missionConfigFile.<br/>See wiki for example.";
    };
};
