...
{
    6SFG_acre2 = "z\6sfg\addons\acre2\ui_scripts\"; //"
};
...
class Cfg3DEN
{
    class Mission
    {
        class 6SFG_MissionAcre2Attributes // Custom section class, everything inside will be opened in one window (MySection)
        {
            ...
            {
                class 6SFG_AcreGeneralSettings
                {
                    displayName = "6SFG: General ACRE2 settings"; // Category name visible in Edit Attributes window
                    collapsed = 0; // When 1, the category is collapsed by default
                    class Attributes
                    {
                        class Network_Enabled
                        {
                            property = "6SFG_AcreNetworkEnabled";
                            displayName = "Enable custom networks";
                            control = "Checkbox";
                            //expression = "missionNamespace setVariable ['6SFG_NetworkEnabled',_value];";
                        ...
                        class Babel_Enabled
                        {
                            property = "6SFG_AcreBabelEnabled";
                            displayName = "Babel enabled:";
                            control = "Checkbox";
                            //expression = "missionNamespace setVariable ['6SFG_BabelEnabled',_value];";
                        ...
                        class Action_Radios
                        {
                            property = "6SFG_AcreAddRadioActions";
                            displayName = "Action radios:";
                            control = "6SFG_AcreAddRadioActions";
                            //expression = "missionNamespace setVariable ['6SFG_AcreAddRadioActions',_value];";
                ...
                class 6SFG_AcreBabelSettings
                {
                    displayName = "6SFG: Languages (Babel System)"; // Category name visible in Edit Attributes window
                    collapsed = 1; // When 1, the category is collapsed by default
                    class Attributes
                    {
                        class Languages
                        {
                            property = "6SFG_AcreBabelSettings";
                            control = "BabelSettings";
                            //expression = "missionNamespace setVariable ['6SFG_BabelArray',_value];";
                            tooltip = "";
                            defaultValue = "[]";
                            condition = "1";
                            wikiType = "[[String]]";
                ...
                class 6SFG_AcreSettings
                {
                    displayName = "6SFG: Radios"; // Category name visible in Edit Attributes window
                    collapsed = 1; // When 1, the category is collapsed by default
                    class Attributes
                    {
                        class RadioChannels
                        {
                            property = "6SFG_AcreSettings";
                            control = "RadioChannels";
                            displayName = "";
                            tooltip = "";
                            //expression = "missionNamespace setVariable ['6SFG_RadioArray', _value];";
                            defaultValue = "[]";
                            condition = "1";
                            wikiType = "[[String]]";
                        };
    ...
    class Group
    {
        ...
        class AttributeCategories
        {
            ...
            class 6sfgMarker
            {
                class Attributes
                {
                    class 6SFG_BabelLanguages
                    {
                        displayName = "Babel languages"; // Name assigned to UI control class Title
                        tooltip = ""; // Tooltip assigned to UI control class Title
                        property = "6SFG_BabelLanguages"; // Unique config property name saved in SQM
                        control = "None"; // UI control base class displayed in Edit Attributes window, points to Cfg3DEN >> Attributes
                        expression = "[_this,'6SFG_BabelLanguages',_value] call 6sfg_common_fnc_initGroupVar;";// "_this setVariable ['6SFG_BabelLanguages',_value,true];";
                        wikiType = "[[String]]";
                        defaultValue = "[]";
                    };
                    class 6SFG_Network
                    {
                        ...
                        tooltip = ""; // Tooltip assigned to UI control class Title
                        property = "6SFG_Network"; // Unique config property name saved in SQM
                        control = "None"; // UI control base class displayed in Edit Attributes window, points to Cfg3DEN >> Attributes
                        expression = "[_this,'6SFG_Network',_value] call 6sfg_common_fnc_initGroupVar;";// expression = "_this setVariable ['6SFG_Network',_value,true];";
                        wikiType = "[[Number]]";
                        defaultValue = -1;                        
                    };
                    class 6SFG_Channellist
                    {
                        displayName = "Radio channel list"; // Name assigned to UI control class Title
                        tooltip = ""; // Tooltip assigned to UI control class Title
                        property = "6SFG_Channellist"; // Unique config property name saved in SQM
                        control = "None"; // UI control base class displayed in Edit Attributes window, points to Cfg3DEN >> Attributes
                        expression = "[_this,'6SFG_Channellist',_value] call 6sfg_common_fnc_initGroupVar;";// expression = "_this setVariable ['6SFG_Channellist',_value,true];";
                        defaultValue = "[]";
                        wikiType = "[[String]]";
                    };
                    class 6SFG_ChannellistLeader
                    {
                        displayName = "Leader radio channel list"; // Name assigned to UI control class Title
                        tooltip = ""; // Tooltip assigned to UI control class Title
                        property = "6SFG_ChannellistLeader"; // Unique config property name saved in SQM
                        control = "None"; // UI control base class displayed in Edit Attributes window, points to Cfg3DEN >> Attributes
                        expression = "[_this,'6SFG_ChannellistLeader',_value] call 6sfg_common_fnc_initGroupVar;";// expression = "_this setVariable ['6SFG_ChannellistLeader',_value,true];";
                        defaultValue = "[]";
                        wikiType = "[[String]]";
                    };
                };
    ...
    class Object
    {
        ...
        class AttributeCategories
        {
            ...
            class 6sfgMarker
            {
                //displayName = "6SFG: Marker"; // Category name visible in Edit Attributes window
                //collapsed = 1; // When 1, the category is collapsed by default
                class Attributes
                {
                    class 6SFG_Network
                    {
                        ...
                        property = "6SFG_Network"; // Unique config property name saved in SQM
                        control = "None"; // UI control base class displayed in Edit Attributes window, points to Cfg3DEN >> Attributes
                        expression = "_this setVariable ['6SFG_Network',_value,true];";
                        wikiType = "[[Number]]";
                        defaultValue = -1;
                    ...
                    class 6SFG_Channellist
                    {
                        ...
                        property = "6SFG_Channellist"; // Unique config property name saved in SQM
                        control = "None"; // UI control base class displayed in Edit Attributes window, points to Cfg3DEN >> Attributes
                        expression = "_this setVariable ['6SFG_Channellist',_value,true];";
                        defaultValue = "[]";
                        wikiType = "[[String]]";
                        condition = "objectBrain"; // Condition for attribute to appear (see the table below)
                    };
                    class 6SFG_BabelLanguages
                    {
                        ...
                        property = "6SFG_BabelLanguages"; // Unique config property name saved in SQM
                        control = "None"; // UI control base class displayed in Edit Attributes window, points to Cfg3DEN >> Attributes
                        expression = "_this setVariable ['6SFG_BabelLanguages',_value,true];";
                        wikiType = "[[String]]";
                        defaultValue = "[]";
                        condition = "objectBrain"; // Condition for attribute to appear (see the table below)
                    };
    ...
    class Attributes
    {
        ...
        class 6SFG_AcreAddRadioActions : Toolbox {
            scriptName = "AcreAddRadioActions";
            scriptPath = "6SFG_acre2";
            onLoad = "['onLoad',_this,'AcreAddRadioActions','6SFG_acre2',false] call (uinamespace getvariable 'BIS_fnc_initDisplay');"; // 3rd param is the path PATH\scriptName.sqf
            onUnload = "['onUnload',_this,'AcreAddRadioActions','6SFG_acre2',false] call (uinamespace getvariable 'BIS_fnc_initDisplay');";
        ...
        class BabelSettings : Toolbox
        {
            ...
            scriptPath = "6SFG_acre2";
            onLoad = "['onLoad',_this,'BabelSettings','6SFG_acre2',false] call (uinamespace getvariable 'BIS_fnc_initDisplay');"; // 3rd param is the path PATH\scriptName.sqf
            onUnload = "['onUnload',_this,'BabelSettings','6SFG_acre2',false] call (uinamespace getvariable 'BIS_fnc_initDisplay');";
        ...
        class RadioChannels : Toolbox
        {
            ...
            scriptPath = "6SFG_acre2";
            onLoad = "['onLoad',_this,'RadioChannels','6SFG_acre2',false] call (uinamespace getvariable 'BIS_fnc_initDisplay');"; // 3rd param is the path PATH\scriptName.sqf
            onUnload = "['onUnload',_this,'RadioChannels','6SFG_acre2',false] call (uinamespace getvariable 'BIS_fnc_initDisplay');";
