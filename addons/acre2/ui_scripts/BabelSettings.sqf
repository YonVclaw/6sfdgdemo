...
//ret = (get3DENSelected "Object" select 0) set3DENAttribute ["6SFG_Channellist","1"];
//set3DENAttributes [[get3DENSelected "Object","6SFG_Channelset",[1,2,3]]];
...
fn_removeUnitFromLang = {
    ...
    _list = (_unit get3DENAttribute "6SFG_BabelLanguages") params ["_value"];
    if (_value isEqualType []) then {
        ...
        _unit set3DENAttribute ["6SFG_BabelLanguages",str _value];
    };
};
...
fn_removeGroupFromLang = {
    ...
    _list = (_group get3DENAttribute "6SFG_BabelLanguages") params ["_value"];
    if (_value isEqualType []) then {
        //Is Default do nothing
        ...
        _group set3DENAttribute ["6SFG_BabelLanguages",str _value];
    };
...
switch _mode do {
    case "onLoad": {
        ...
        BabelArray = ("6SFG_MissionAcre2Attributes" get3DENMissionAttribute "6SFG_AcreBabelSettings");
    ...
    case "refreshLangTree": {
        ...
        fn_langTreeProcessUnit = {
            ...
            if (!_doSpeak) then {
                private _unitChanList = (_unit get3DENAttribute "6SFG_BabelLanguages") select 0;
            ...
            if (_doSpeak) then {
                _ctrlTree tvSetPictureRight [_location, "z\6sfg\addons\acre2\ui\bable_on.paa"];
                _returnCode = 0;
            } else {
                _ctrlTree tvSetPictureRight [_location, "z\6sfg\addons\acre2\ui\bable_off.paa"];
            };
        ...
        fn_langTreeProcessGroup = {
            ...
            if (!_doSpeak) then {
                private _grpChanList = (_group get3DENAttribute "6SFG_BabelLanguages") select 0;
            ...
            if (_doSpeak) then {
                ...
                if (_hasSpeaker) then {
                    _ctrlTree tvSetPictureRight [_location, "z\6sfg\addons\acre2\ui\bable_partial.paa"];
        ...
        with uiNamespace do {
            ...
            if (_entity isEqualType east or _entity isEqualType "") then {
                ...
                if (_entity isEqualType grpNull or _entity isEqualType objNull) then {
                    _list = (_entity get3DENAttribute "6SFG_BabelLanguages") params ["_value"];
                    if (_value isEqualType []) then {
                        _entity set3DENAttribute ["6SFG_BabelLanguages",str [_curSel]];
                    } else {
                        _value = call compile _value;
                        _value pushBackUnique _curSel;
                        _entity set3DENAttribute ["6SFG_BabelLanguages",str _value];
                    };
                };
            };
    ...
    case "save": {
        ...
        private _string = str _array;
        set3DENMissionAttributes [["6sfgMissionAcreAttributes","6SFG_AcreBabelSettings",_string]];
    };
};
