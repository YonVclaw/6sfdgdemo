...
switch _mode do {
    case "onLoad": {
        ...
        6SFG_AcreAddRadioActions_Array = ("6SFG_MissionAcre2Attributes" get3DENMissionAttribute "6SFG_AcreAddRadioActions");
        if (6SFG_AcreAddRadioActions_Array isEqualType "") then {
            6SFG_AcreAddRadioActions_Array = call compile 6SFG_AcreAddRadioActions_Array;
        };
        ...
        _ctrlList lnbSetColumnsPos [0.1,0.2];
        {
            ...
            _alpha = if (_x in 6SFG_AcreAddRadioActions_Array) then {1} else {0.5};
            _ctrlList lnbsetcolor [[_lnbAdd,1],[1,1,1,_alpha]];
        } forEach ACRE_RADIO_CLASSNAME_ARRAY;
    };
    case "attributeSave": {
        str (uiNamespace getVariable "6SFG_AcreAddRadioActions_Array")
    };
    case "listModify": {
        ...
        if (_radio in 6SFG_AcreAddRadioActions_Array) then {
            6SFG_AcreAddRadioActions_Array = 6SFG_AcreAddRadioActions_Array - [_radio];
        } else {
            6SFG_AcreAddRadioActions_Array pushBackUnique _radio;
        };
        lnbclear _ctrlList;
        _ctrlList lnbSetColumnsPos [0.1,0.2];
        {
