...
/* ----------------------------------------------------------------------------
Function: 6SFG_acre2_fnc_testNets
...
if (getmissionconfigvalue ["6SFG_AcreNetworkEnabled",false]) then {
    LOG("Running Autotest on Radio Networks");
    private _networksArray = getMissionConfigValue ['6SFG_AcreSettings', []];
...

    {
        ...
        if (_index == -1) then {
            ...
            private _groupCond = _grp getVariable ["6SFG_Network", -1];
