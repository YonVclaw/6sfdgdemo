...
GVAR(directionalFTMarkers) = getMissionConfigValue ["6SFG_ORBATMarkersFT_Directional",false];
...
GVAR(orbatTrackerCodeCondition) = getMissionConfigValue ["6SFG_ORBATTrackerCondition","true"];
...
GVAR(ftMarkersEnabled) = getMissionConfigValue ['6SFG_ORBATMarkersFT', false];
FUNC(PFHUpdate) = {
