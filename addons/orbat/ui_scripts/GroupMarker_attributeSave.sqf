...
private _sizeMod = ["z\6sfg\addons\orbat\textures\empty.paa", "z\6sfg\addons\orbat\textures\modif_o.paa","z\6sfg\addons\orbat\textures\modif_dot.paa","z\6sfg\addons\orbat\textures\modif_2dot.paa","z\6sfg\addons\orbat\textures\modif_3dot.paa", "z\6sfg\addons\orbat\textures\modif_company.paa"];

private _icon = _toolBoxIcon select (lbcursel _ctrlIconToolbox);
private _path = "";

if (_icon != "") then {
    _path = "z\6sfg\addons\orbat\textures\" + (_colours select  (lbcursel _ctrlColourToolBox)) + _icon;
};
...
_entity set3DENAttribute ["6SFG_groupMarker",str _groupMarkerArray];
