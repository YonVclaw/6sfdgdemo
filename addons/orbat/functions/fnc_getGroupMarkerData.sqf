...
private _cachedData = _group getVariable ["6SFG_groupMarker_Cached",-1];
if (_cachedData isEqualTo -1) exitWith {
    private _data = _group getVariable ["6SFG_groupMarker",[]];
    ...
    _group setVariable ["6SFG_groupMarker_Cached", _data];
    _data;
};
