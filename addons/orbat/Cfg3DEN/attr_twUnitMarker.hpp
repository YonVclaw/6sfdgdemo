class twUnitMarker: Toolbox
{
    ...
    onLoad = "['onLoad',_this,'UnitMarker','6SFG_orbat',false] call (uinamespace getvariable 'BIS_fnc_initDisplay');"; // 3rd param is the path PATH\scriptName.sqf
    onUnload = "['onUnload',_this,'UnitMarker','6SFG_orbat',false] call (uinamespace getvariable 'BIS_fnc_initDisplay');";
