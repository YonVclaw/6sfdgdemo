class 6SFG_ORBAT_Renamer : Title
{
    onLoad = "uiNamespace setVariable ['6SFG_OrbatRenamer_ctrlGroup', (_this select 0)];";
    attributeLoad = "";
    attributeSave = "true";
    h = 5 * SIZE_M * GRID_H;
    class Controls : Controls
    {
        ...
        class orbatRenamerButton : RscButtonMenu
        {
            ...
            y = 3.5 * SIZE_M * GRID_H;
            action = "[] call (missionNamespace getVariable '6sfg_orbat_fnc_renameUnitAndGroups');";
