...
{
    6SFG_briefing = "z\6sfg\addons\briefing\ui_scripts\"; //" - Escape for VS code linter
};
...
class Cfg3DEN
{
    class Mission
    {
        class 6SFG_MissionBriefingAttributes // Custom section class, everything inside will be opened in one window (MySection)
        {
            displayName = "6SFG Briefing settings"; // Text visible in the window title as "Edit <displayName>"
            ...
            {
                class 6SFG_BriefingSettings
                {
                    displayName = "6SFG: Briefing settings"; // Category name visible in Edit Attributes window
                    collapsed = 0; // When 1, the category is collapsed by default
                    class Attributes
                    {
                        class 6SFG_Briefing_Loadout
                        {
                            property = "6SFG_Briefing_Loadout";
                            ...
                            control = "Checkbox";
                            //expression = "missionNamespace setVariable ['6SFG_Briefing_Loadout',_value];";
                            defaultValue = "false";
                            condition = "1";
                        };
                        class 6SFG_Briefing
                        {
                            property = "6SFG_Briefing";
                            displayName = "";
                            control = "BriefingSettings";
                            //expression = "missionNamespace setVariable ['6SFG_BriefingArray',_value];";
    ...
    class Group
    {
        ...
        class AttributeCategories
        {
            ...
            class 6sfgMarker
            {
                class Attributes
                {
                    class 6SFG_Briefinglist
                    {
                        displayName = ""; // Name assigned to UI control class Title
                        tooltip = ""; // Tooltip assigned to UI control class Title
                        property = "6SFG_Briefinglist"; // Unique config property name saved in SQM
                        control = "None"; // UI control base class displayed in Edit Attributes window, points to Cfg3DEN >> Attributes
                        expression =  "[_this,'6SFG_Briefinglist',_value] call 6sfg_common_fnc_initGroupVar;";// "_this setVariable ['6SFG_Briefinglist',_value],true;";
                        defaultValue = "[]";
                        wikiType = "[[String]]";
                    };
                };
            ...
            class 6sfgMarker
            {
                class Attributes
                {
                    class 6SFG_Briefinglist
                    {
                        ...
                        property = "6SFG_Briefinglist"; // Unique config property name saved in SQM
                        control = "None"; // UI control base class displayed in Edit Attributes window, points to Cfg3DEN >> Attributes
                        expression = "_this setVariable ['6SFG_Briefinglist',_value,true];";
                        defaultValue = "[]";
                        wikiType = "[[String]]";
    ...
    class Attributes
    {
        ...
        class BriefingSettings : Toolbox
        {
            ...
            scriptPath = "6SFG_briefing";
            onLoad = "['onLoad',_this,'BriefingSettings','6SFG_briefing',false] call (uinamespace getvariable 'BIS_fnc_initDisplay');"; // 3rd param is the path PATH\scriptName.sqf
            onUnload = "['onUnload',_this,'BriefingSettings','6SFG_briefing',false] call (uinamespace getvariable 'BIS_fnc_initDisplay');";
