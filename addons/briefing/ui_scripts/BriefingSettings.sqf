...
fn_removeUnitFromBrief = {
    ...
    _list = (_unit get3DENAttribute "6SFG_Briefinglist") params ["_value"];
    if (_value isEqualType []) then {
        //Is default do nothing
        _//unit set3DENAttribute ["6SFG_Channellist",str []];
    } else {
        _value = call compile _value;
        _value = _value - [_channel];
        _unit set3DENAttribute ["6SFG_Briefinglist",str _value];
    };
};
...
fn_removeGroupFromBrief = {
    ...
    _list = (_group get3DENAttribute "6SFG_Briefinglist") params ["_value"];
    if (_value isEqualType []) then {
        //Is Default do nothing
        ...
        _group set3DENAttribute ["6SFG_Briefinglist",str _value];
    };
...
switch _mode do {
    case "onLoad": {
        ...
        BriefingArray = ("6SFG_MissionBriefingAttributes" get3DENMissionAttribute "6SFG_Briefing");
    ...
    case "refreshBriefTree": {
        ...
        fn_BriefTreeProcessUnit = {
            ...
            if (!_doSpeak) then {
                private _unitChanList = (_unit get3DENAttribute "6SFG_Briefinglist") select 0;
            ...
            if (_doSpeak) then {
                _ctrlTree tvSetPictureRight [_location, "z\6sfg\addons\briefing\UI\check_small_ca.paa"];
                _returnCode = 0;
            } else {
                _ctrlTree tvSetPictureRight [_location, "z\6sfg\addons\briefing\UI\plus_small_ca.paa"];
            };
        ...
        fn_BriefTreeProcessGroup = {
            ...
            if (!_doSpeak) then {
                private _grpChanList = (_group get3DENAttribute "6SFG_Briefinglist") select 0;
        ...
        with uiNamespace do {
            ...
            if (_entity isEqualType east or _entity isEqualType "") then {
                ...
                if (_entity isEqualType grpNull or _entity isEqualType objNull) then {
                    _list = (_entity get3DENAttribute "6SFG_Briefinglist") params ["_value"];
                    if (_value isEqualType []) then {
                        _entity set3DENAttribute ["6SFG_Briefinglist",str [_curSel]];
                    } else {
                        _value = call compile _value;
                        _value pushBackUnique _curSel;
                        _entity set3DENAttribute ["6SFG_Briefinglist",str _value];
                    };
                };
            };
    ...
    case "save": {
        ...
        private _string = str _array;
        set3DENMissionAttributes [["6SFG_MissionBriefingAttributes","6SFG_Briefing",_string]];
    };
};
