...
/* ----------------------------------------------------------------------------
Internal Function: 6SFG_adminmenu_fnc_messageLog_print
...
Examples:
    (begin example)
        [_ctrl] call 6SFG_adminmenu_fnc_messageLog_print;
    (end)
...
private _lbCtrl = _display displayCtrl IDC_6SFG_ADMINMENU_MSGS_LIST;
...
private _return = format [
    "[6SFG Adminmenu] Printed entry: %1%2",
