...
/* ----------------------------------------------------------------------------
Internal Function: 6SFG_adminmenu_fnc_messageLog_printAll
...
Examples:
    (begin example)
        [] call 6SFG_adminmenu_fnc_messageLog_printAll;
    (end)
...
diag_log "[6SFG Adminmenu] Printing complete log to RPT";
...
diag_log "[6SFG Adminmenu] Log end";
