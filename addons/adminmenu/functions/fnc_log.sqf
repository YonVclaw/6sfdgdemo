...
/* ----------------------------------------------------------------------------
Function: 6SFG_adminmenu_fnc_log
...
Parameters:
    ...
    _tag - Tag that message will be prefixed with [String, defaults to "[6SFG Log]"]
...
Examples:
    (begin example)
        ["Everything is on fire!",true,"[6SFG Firealarm]"] call 6SFG_adminmenu_fnc_log;
    (end)
    (begin example)
        [format ["%1 did something",profileName]] call 6SFG_adminmenu_fnc_log;
    (end)
